...
<head>
<meta charset="utf-8">
<title>Recruit10X / <?php echo $title;?></title>
...
.navbar {
    background-color: rgba(0, 0, 0, 0.8); /* Solid color with some transparency */
         ...
         <div class="navbar navbar-default navbar-fixed-top" style="top: 30px;" >
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php"><img src="<?php echo web_root; ?>plugins/home-plugins/img/logo10x.png" alt="logo"/> </a>
                </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; Recruit10X&nbsp; 2024 All Right Reserved.
            </p>
          </div>
        </div>
        <div class="col-lg-6">
